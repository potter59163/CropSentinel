...
export const PLANTS: Plant[] = [
  ...
  P('peanut', 'ถั่วลิสง', 'Peanut', 'groundcover', 'พืชล้มลุก', 'พืชตระกูลถั่ว', 0, 1500, false, 1, 1, 35, 250, 0.35, 0, true, 'low', 1200, 1500, 2, 'peanut', 'ตรึงไนโตรเจนบำรุงดิน คลุมหน้าดิน เหมาะอากาศอุ่นและดินไม่แฉะ'),
  ...
  P('pineapple', 'สับปะรด', 'Pineapple', 'groundcover', 'พืชล้มลุก', 'ไม้ผลล้มลุก', 0, 1000, false, 2, 2, 13.5, 3362, 0.25, 0, false, 'low', 5000, 1500, 1, 'pineapple', 'คลุมดินกันวัชพืช ทนแล้ง เหมาะพื้นที่ร้อนและดินระบายน้ำดี'),

  // ── พืชหัวใต้ดิน (root) ──
  P('ginger', 'ขิง', 'Ginger', 'root', 'พืชล้มลุกมีเหง้า', 'พืชหัว', 300, 1200, false, 1, 1, 30, 2000, 0.6, 0, false, 'high', 6000, 4000, 1, 'ginger', 'ชอบร่มรำไร รายได้ต่อไร่สูง ต้องการความชื้นสม่ำเสมอ'),
  P('turmeric', 'ขมิ้น', 'Turmeric', 'root', 'พืชล้มลุกมีเหง้า', 'พืชหัว/สมุนไพร', 200, 1200, false, 1, 1, 18, 2500, 0.65, 0, false, 'med', 3500, 2500, 1, 'turmeric', 'ทนร่มเงาดีมาก เหมาะใต้ไม้ผล/กล้วย ดินต้องไม่แฉะ'),
  P('taro', 'เผือก', 'Taro', 'root', 'พืชล้มลุกมีหัว', 'พืชหัว', 0, 1200, false, 1, 1, 22, 2500, 0.5, 0, false, 'high', 3000, 2500, 1, 'taro', 'ชอบดินชื้น เหมาะที่ลุ่ม/ร่องน้ำใต้ร่ม ไม่เหมาะแล้งจัด'),
