...
export const PLANTS: Plant[] = [
  ...
  P('pradu', 'ประดู่ป่า', 'Burma padauk', 'canopy', 'ไม้ต้น', 'ไม้เศรษฐกิจ', 100, 700, true, 20, 30, 35, 2500, 0.2, 0.6, true, 'low', 4000, 1200, 1, undefined, 'ไม้ดู่พื้นเมืองน่าน โตช้าแต่ทนแล้ง เป็นเงินออมระยะยาว ปลูกได้ดีต่ำกว่า 700 ม. และควรอยู่ในที่ดินมีเอกสารสิทธิ์จึงตัดขายได้สะดวก'),
