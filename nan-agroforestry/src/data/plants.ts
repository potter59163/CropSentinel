...
export const PLANTS: Plant[] = [
  ...
  P('chili', 'พริก', 'Chili', '🌶️', 'shrub', 'พืชผัก', 200, 1000, false, 1, 1, 45, 1200, 0.3, 0.2, false, 'med', 3000, 3500, 2, 'chili', 'รายได้ดี เก็บได้หลายรอบ ต้องการแดดพอควร'),
  P('tea', 'ชาเมี่ยง', 'Assam tea', '🍵', 'shrub', 'เครื่องดื่ม', 600, 1500, true, 4, 6, 60, 350, 0.6, 0.3, false, 'med', 7000, 2500, 2, 'tea', 'พืชใต้ร่มดั้งเดิมภาคเหนือ เก็บได้หลายรอบ'),
  P('lemongrass', 'ตะไคร้', 'Lemongrass', '🌾', 'shrub', 'สมุนไพร', 100, 1000, false, 1, 1, 15, 2000, 0.4, 0.15, false, 'low', 2500, 1500, 1, 'lemongrass', 'ปลูกง่าย ทนแล้ง ไล่แมลง'),

  // ── ไม้คลุมดิน (groundcover) ──
  P('peanut', 'ถั่วลิสง', 'Peanut', '🥜', 'groundcover', 'พืชตระกูลถั่ว', 200, 1200, false, 1, 1, 35, 250, 0.35, 0, true, 'low', 1200, 1500, 2, 'peanut', 'ตรึงไนโตรเจนบำรุงดิน คลุมหน้าดิน'),
  P('pumpkin', 'ฟักทอง', 'Pumpkin', '🎃', 'groundcover', 'พืชเลื้อย', 200, 1000, false, 1, 1, 14, 1800, 0.25, 0, false, 'med', 2500, 2000, 1, 'pumpkin', 'เลื้อยคลุมดิน เก็บง่าย'),
  P('sweetpotato', 'มันเทศ', 'Sweet potato', '🍠', 'groundcover', 'พืชเลื้อย/หัว', 100, 1000, false, 1, 1, 18, 2200, 0.35, 0, false, 'low', 2500, 2000, 1, 'sweetpotato', 'คลุมดินดี หัวขายได้ ทนแล้ง'),
  P('pineapple', 'สับปะรด', 'Pineapple', '🍍', 'groundcover', 'ไม้ผลล้มลุก', 100, 800, false, 2, 2, 14, 4000, 0.25, 0, false, 'low', 5000, 1500, 1, 'pineapple', 'คลุมดินกันวัชพืช ทนแล้ง'),

  // ── ไม้ลงดิน (root) ──
  P('ginger', 'ขิง', 'Ginger', '🫚', 'root', 'พืชหัว', 300, 1000, false, 1, 1, 30, 2000, 0.6, 0, false, 'high', 6000, 4000, 1, 'ginger', 'ชอบร่มรำไร รายได้ต่อไร่สูง'),
  P('turmeric', 'ขมิ้น', 'Turmeric', '🟡', 'root', 'พืชหัว/สมุนไพร', 200, 900, false, 1, 1, 18, 2500, 0.65, 0, false, 'med', 3500, 2500, 1, 'turmeric', 'ทนร่มเงาดีมาก ตลาดสมุนไพรต่อเนื่อง'),
  P('taro', 'เผือก', 'Taro', '🟣', 'root', 'พืชหัว', 200, 900, false, 1, 1, 22, 2500, 0.5, 0, false, 'high', 3000, 2500, 1, 'taro', 'ชอบดินชื้น เหมาะที่ลุ่มใต้ร่ม'),
  P('galangal', 'ข่า', 'Galangal', '🌱', 'root', 'พืชหัว/เครื่องเทศ', 200, 1000, true, 1, 2, 25, 2000, 0.6, 0, false, 'med', 3000, 2000, 1, 'galangal', 'ทนร่ม ปลูกครั้งเดียวเก็บได้นาน'),
];
